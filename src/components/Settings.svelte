                            ...
                            <div class="dataset-card">
                                <div class="dataset-row">
                                    <button class="expand-btn" onclick={() => toggleDatasetEdit(ds.id)}>
                                        <div class="color-dot" style:background="hsl({ds.hue}, 70%, 50%)"></div>
                                        <div style="display:flex; flex-direction:column; gap:2px;">
                                            <span class="ds-name">{ds.name}</span>
                                            <span class="ds-meta">
                                                {ds.graphType === 'line' ? 'Linje' : 'Stapel'} • {ds.graphMode.toUpperCase()}
                                            </span>
                                        </div>
                                    </button>
                                    ...
                                    <div class="dataset-controls" transition:slide={{duration: 200, easing: quintOut}}>
                                        ...
                                        <div class="setting-group" style="margin-bottom:8px">
                                            ...
                                            <div class="hue-wrapper">
                                                ...
                                                <div 
                                                    class="hue-preview" 
                                                    style:background="hsl({ds.hue}, 70%, 50%)"
                                                ></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="action-row" style:margin-top="12px">
                                            <button 
                                                ...
                                                onclick={() => dataStore.cloneDataset(ds.id)} 
                                                title="Duplicera"
                                            >
                                                <span>📋</span> Duplicera
                                            </button>
                                            {#if dataStore.datasets.length > 1}
                                                <button 
                                                    ...
                                                    onclick={() => dataStore.removeDataset(ds.id)} 
                                                    title="Ta bort"
                                                >
                                                    <span>🗑️</span> Ta bort
                                                </button>
...
<style>
    ...
    .setting-group .group-label { 
        display: block; font-size: 11px; font-weight: 700; margin-bottom: 8px; 
    ...
    .axis-input {
        ...
        transition: all 0.2s; appearance: textfield; -moz-appearance: textfield;
    }
    ...
    .control-section-label {
        font-size: 10px; font-weight: 800; color: #00639b; 
        opacity: 0.6; margin-bottom: 4px; letter-spacing: 0.5px;
    }
